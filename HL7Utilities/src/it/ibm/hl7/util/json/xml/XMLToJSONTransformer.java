package it.ibm.hl7.util.json.xml;

import it.ibm.hl7.util.json.xml.internal.JSONSAXHandler;
...
public class XMLToJSONTransformer
{
	...
	private static String className = "it.ibm.hl7.util.json.xml.transform.XMLToJSONTransformer";
